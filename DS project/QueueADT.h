...
public:
    ...
    virtual bool enqueue(const ItemType& newEntry) = 0; //normal 
    virtual bool enqueue(const ItemType& newEntry,int priority) = 0; //priority
    virtual bool enqueuelowest(const ItemType& newEntry, int priority) = 0; //priority
